const moduleTest = {
  ...
  mutations: {
    ...
    //   }
    //   this.dispatch('FETCH_RANDOM_ANIME')
    ...
    //       this.commit('resetCurrentlyPlaying')
    //       this.commit('updateUrl', {newUrl: randomOps[randomOp]['opUrl'], sourse: "themes", opJson: randomOps[randomOp]})
